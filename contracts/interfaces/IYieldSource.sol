...
interface IYieldSource is IERC20 {
    ...
    /// @notice Supplies tokens to the yield source.
    ...
    /// @notice Withdraws accrued interest from the yieldSource.
    ...
    /// @notice Returns the total number of deposited funds along with accrued interest.
    /// @return The uin256 value of totalBalance.
    function totalBalance() external view returns (uint256);

    /// @notice Returns the total accrued interest.
